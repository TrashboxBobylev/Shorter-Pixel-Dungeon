		...
		if (phase == 1) {
			...
			if (Dungeon.isChallenged(Challenges.STRONGER_BOSSES)){
				...
				if (summonsMade < 6){
					...
					summonsMade += 2;
					return true;
				} else if (shielding() <= 120 && summonsMade < 12){
					if (summonsMade == 6) {
						sprite.centerEmitter().start(Speck.factory(Speck.SCREAM), 0.4f, 2);
						Sample.INSTANCE.play(Assets.Sounds.CHALLENGE);
					...
					spend(3*TICK);
					return true;
				} else if (shielding() <= 60 && summonsMade < 18) {
					if (summonsMade == 12) {
						sprite.centerEmitter().start(Speck.factory(Speck.SCREAM), 0.4f, 2);
						Sample.INSTANCE.play(Assets.Sounds.CHALLENGE);
				...
				if (summonsMade < 4) {
					...
					summonsMade++;
					return true;
				} else if (shielding() <= 80 && summonsMade < 8) {
					if (summonsMade == 4) {
						sprite.centerEmitter().start(Speck.factory(Speck.SCREAM), 0.4f, 2);
						Sample.INSTANCE.play(Assets.Sounds.CHALLENGE);
						yell(Messages.get(this, "wave_2"));
					...
					if (summonsMade == 7) {
						summonSubject(3, Random.Int(2) == 0 ? DKGhoul.class : DKMonk.class);
					} else {
						summonSubject(3, DKGhoul.class);
					}
					summonsMade++;
					spend(TICK);
					return true;
				} else if (shielding() <= 40 && summonsMade < 12) {
					sprite.centerEmitter().start(Speck.factory(Speck.SCREAM), 0.4f, 2);
					Sample.INSTANCE.play(Assets.Sounds.CHALLENGE);
					yell(Messages.get(this, "wave_3"));
