...
public class TitleScene extends PixelScene {
	...
	public void create() {
		...
		btnAbout.icon(Icons.get(Icons.SHORTER_CHEST));
		add(btnAbout);
		...
		if (landscape()) {
			...
			align(btnPlay);
			btnRankings.setRect(btnPlay.left(), btnPlay.bottom()+ GAP, (btnPlay.width()*.5f), BTN_HEIGHT);
			btnBadges.setRect(btnRankings.right(), btnPlay.bottom()+GAP, btnRankings.width(), BTN_HEIGHT);
			btnChanges.setRect(btnRankings.left(), btnRankings.bottom() + GAP,(btnPlay.width()*.34f)-0.9f, BTN_HEIGHT);
			btnSettings.setRect(btnChanges.right(), btnChanges.top(), btnChanges.width(), BTN_HEIGHT);
			btnAbout.setRect(btnSettings.right(), btnChanges.top(), btnChanges.width(), BTN_HEIGHT);
		} else {
			...
			btnAbout.setRect(btnChanges.left(), btnSettings.bottom()+GAP, btnPlay.width(), BTN_HEIGHT);
		}
				...
				ShatteredPixelDungeon.scene().addToFront( new WndOptions(
					...
					protected void onSelect(int index) {
						if (index == 0) {
							...
							ChangesScene.changesSelected = 8;
